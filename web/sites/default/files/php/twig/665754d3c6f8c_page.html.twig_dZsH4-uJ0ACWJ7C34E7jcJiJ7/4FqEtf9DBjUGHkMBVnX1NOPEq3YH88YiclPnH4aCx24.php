  ...
  <div id=\"page\">
    <div id=\"header\">
      <div class=\"content\">
        ...
        <div id=\"vision-century\" class=\"row\">
              <!-- Begin Middle header bottom-->
              ";
        // line 60
        if (twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "middle_header_bottom", [], "any", false, false, true, 60)) {
            // line 61
            echo "                  <div id=\"middle-header-bottom\" class=\"column\">
                      <div class=\"content\">
                          ";
            // line 63
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "middle_header_bottom", [], "any", false, false, true, 63), 63, $this->source), "html", null, true);
            echo "
                      </div>
                  </div>
              ";
        ...
        <div id=\"electronic-services-slider\" class=\"row\">
              <!-- Begin Bottom header -->
              ";
        // line 71
        if (twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "bottom_header", [], "any", false, false, true, 71)) {
            // line 72
            echo "                  <div id=\"bottom-header\" class=\"column\">
                      <div class=\"content\">
                          ";
            // line 74
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "bottom_header", [], "any", false, false, true, 74), 74, $this->source), "html", null, true);
            echo "
                      </div>
                  </div>
              ";
    ...
    <div id=\"main-wrapper\">
      <div id=\"main\">
          <div id=\"court-news\" class=\"row\">
              <!-- Begin Highlighted first-->
              ";
        // line 86
        if (twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "highlighted_first", [], "any", false, false, true, 86)) {
            // line 87
            echo "                  <div id=\"highlighted-first\">
                      <div class=\"content\">
                          ";
            // line 89
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "highlighted_first", [], "any", false, false, true, 89), 89, $this->source), "html", null, true);
            echo "
                      </div>
                  </div>
              ";
    ...
    {
        return array (  200 => 96,  195 => 93,  188 => 89,  184 => 87,  182 => 86,  172 => 78,  165 => 74,  161 => 72,  159 => 71,  153 => 67,  146 => 63,  142 => 61,  140 => 60,  134 => 56,  127 => 52,  123 => 50,  121 => 49,  115 => 45,  108 => 41,  104 => 39,  102 => 38,  97 => 35,  90 => 31,  86 => 29,  84 => 28,  78 => 24,  71 => 20,  67 => 18,  65 => 17,  60 => 14,  53 => 10,  49 => 8,  47 => 7,  39 => 1,);
    }
